/*
 * @Author: NineNan
 * @Date: 2021-04-01 17:14:36
 * @LastEditTime: 2021-04-01 18:03:13
 * @LastEditors: Please set LastEditors
 * @Description: defaults test
 * @FilePath: \ts-axios\test\defaults.spec.ts
 */
...
describe('defaults', () => {
  ...
  test('should not be used by custom if set after instance created', () => {
    const instance = axios.create()
    axios.defaults.baseURL = 'http://example.org/'
